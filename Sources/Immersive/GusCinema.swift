...
enum GusCinemaPalette {
    ...
    static let backdropNightUI = UIColor(red: 0.071, green: 0.055, blue: 0.133, alpha: 1)
    // backdrop mid — plum #2A1B3D
    static let backdropMidUI = UIColor(red: 0.165, green: 0.106, blue: 0.239, alpha: 1)
    // key light — pineapple gold #F4B740
    static let keyLightUI = UIColor(red: 0.957, green: 0.718, blue: 0.251, alpha: 1)
    // fill light — radio-neon magenta #E0529C
    static let fillLightUI = UIColor(red: 0.878, green: 0.322, blue: 0.612, alpha: 1)

    static var backdropNightCG: CGColor { backdropNightUI.cgColor }
    static var backdropMidCG: CGColor { backdropMidUI.cgColor }
}
#endif
